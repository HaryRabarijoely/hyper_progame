import {searchGame, showInfo, hideInfo, convertDate, addCreators, platformsIcons, storeIcons, seePlatform,} from "./tools";
    ...
    const preparePage = () => {
      ...
      const fetchYoutube = (url) => {
        fetch(url)
          ...
          .then((response) => {
            ...
            document.getElementById("youtube-mini").innerHTML = toInsertYoutubeMini;
          });
      };
      ...
      const fetchGame = (url, argument) => {
        ...
        fetch(`${finalURL}`)
          .then((response) => response.json())
          .then((response) => {
            let {background_image, website, name, rating, ratings_count, released, description, developers, platforms, publishers, genres, tags, stores, clip, screenshots_count, slug} = response;
            ...
            if (description) {
              ...
              document.getElementById("description").innerHTML = "No data on this";
            }
  
            if (released) {
              document.querySelector(".release").innerHTML = convertDate(released);
            } else {
            ...
            if (developers) {
              ...
              document.querySelector(".developers").innerHTML = toInsertDevelopers;
            } else {
            ...
            if (publishers) {
              ...
              document.querySelector(".publishers").innerHTML = toInsertPublishers;
            } else {
            ...
            if (screenshots_count > 0) {
              fetchScreenshots(`https://api.rawg.io/api/games/${slug}/screenshots`);
            }
            ...
            if (clip) {
              ...
              document.getElementById("youtube").innerHTML = "<p>No data on this<p>";
            }
